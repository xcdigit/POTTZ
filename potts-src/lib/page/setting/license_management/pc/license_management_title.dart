...
class LicenseManagementTitle extends StatefulWidget {
  // 标记
  String flag;

  LicenseManagementTitle({super.key, this.flag = ''});

  @override
  State<LicenseManagementTitle> createState() => _LicenseManagementTitleState();
}

class _LicenseManagementTitleState extends State<LicenseManagementTitle> {
  // 当前悬停下标
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: Text(
              WMSLocalizations.i18n(context)!.menu_content_98_23,
              style: TextStyle(
                fontWeight: FontWeight.w500,
                fontSize: 24,
                height: 1.0,
