...
class MenuMasterTitle extends StatefulWidget {
  // 标记
  String flag;

  MenuMasterTitle({super.key, this.flag = ''});

  @override
  State<MenuMasterTitle> createState() => _MenuMasterTitleState();
}

class _MenuMasterTitleState extends State<MenuMasterTitle> {
  // 当前悬停下标
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: Text(
              WMSLocalizations.i18n(context)!.menu_content_98_5,
              style: TextStyle(
                fontWeight: FontWeight.w500,
                fontSize: 24,
                height: 1.0,
