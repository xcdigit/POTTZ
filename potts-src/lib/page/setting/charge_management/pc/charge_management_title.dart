...
class ChargeManagementTitle extends StatefulWidget {
  // 标记
  String flag;

  ChargeManagementTitle({super.key, this.flag = ''});

  @override
  State<ChargeManagementTitle> createState() => _ChargeManagementTitleState();
}

class _ChargeManagementTitleState extends State<ChargeManagementTitle> {
  // 当前悬停下标
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: Text(
              WMSLocalizations.i18n(context)!.menu_content_98_22,
              style: TextStyle(
                fontWeight: FontWeight.w500,
                fontSize: 24,
                height: 1.0,
