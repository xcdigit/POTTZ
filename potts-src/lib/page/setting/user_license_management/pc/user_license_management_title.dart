...
class UserLicenseManagementTitle extends StatefulWidget {
  // 标记
  String flag;

  UserLicenseManagementTitle({super.key, this.flag = ''});

  @override
  State<UserLicenseManagementTitle> createState() =>
      _UserLicenseManagementTitleState();
}

class _UserLicenseManagementTitleState
    extends State<UserLicenseManagementTitle> {
  // 当前悬停下标
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: Text(
              WMSLocalizations.i18n(context)!.menu_content_98_24,
              style: TextStyle(
                fontWeight: FontWeight.w500,
                fontSize: 24,
                height: 1.0,
