...
class OrganizationMasterFormContent extends StatefulWidget {
  final String flag_num;
  const OrganizationMasterFormContent({super.key, required this.flag_num});

  @override
  State<OrganizationMasterFormContent> createState() =>
      _OrganizationMasterFormContentState();
}

class _OrganizationMasterFormContentState
    extends State<OrganizationMasterFormContent> {
  @override
  Widget build(BuildContext context) {
                      ...
                      WMSDropdownWidget(
                        ...
                        selectedCallBack: (value) {
                          ...
                          if (value is! String) {
                            ...
                            context.read<OrganizationMasterBloc>().add(
                                SetMessageValueEvent('company_name', null));
            ...
            child: OutlinedButton(
              ...
              onPressed: () {
                ...
                if (buttonItemList[i]['index'] == Config.NUMBER_ZERO) {
                  //清除表单数据
                  context.read<OrganizationMasterBloc>().add(ClearFormEvent());
