...
import '../../chat_bots/dialog_messenger.dart';
...
class HomePage extends StatefulWidget {
  ...
  HomePage({required this.child, super.key});
...
class _HomePageState extends State<HomePage> {
  ...
  List<Map<String, dynamic>> _createAdminMenuList() {
    return [
      {
        "index": Config.MENU_FLAG_ADMIN_1,
        "icon": WMSICons.MENU_ICON_ADMIN_1,
        "route": '', // 首页
        "type": 'Menu',
      },
      {
        "index": Config.MENU_FLAG_ADMIN_2,
        "icon": WMSICons.MENU_ICON_ADMIN_2,
        "type": 'Menu', //法人管理
        "children": [
          {
            "index": Config.MENU_FLAG_ADMIN_2_1,
            "icon": '',
            "route": 'corporateManagement/0', // 契約内容の確認
          },
          {
            "index": Config.MENU_FLAG_ADMIN_2_2,
            "icon": '',
            "route": 'corporateManagement/1', // アカウント追加
          },
        ]
      },
      {
        "index": Config.MENU_FLAG_ADMIN_3,
        "icon": WMSICons.MENU_ICON_ADMIN_3,
        "type": 'Menu', //プラン管理
        "children": [
          {
            "index": Config.MENU_FLAG_ADMIN_3_1,
            "icon": '',
            "route": 'planManagement/0', //　プラン追加・削除
          },
          {
            "index": Config.MENU_FLAG_ADMIN_3_2,
            "icon": '',
            "route": 'planManagement/1', //　プラン内容変更
          },
        ]
      },
      {
        "index": Config.MENU_FLAG_ADMIN_4,
        "icon": WMSICons.MENU_ICON_ADMIN_4,
        "type": 'Menu', //メッセージ
        "children": [
          {
            "index": Config.MENU_FLAG_ADMIN_4_1,
            "icon": '',
            "route": Config.PAGE_FLAG_50_2 + '/notice/-1', // メッセージ一覧
          },
          {
            "index": Config.MENU_FLAG_ADMIN_4_2,
            "icon": '',
            "route": Config.PAGE_FLAG_98_11, // メッセージ作成
          },
        ]
      },
      {
      ...
      {
        "index": Config.MENU_FLAG_98_25,
        "icon": WMSICons.MENU_ICON_ADMIN_5,
        "route": Config.PAGE_FLAG_98_25,
        "type": 'Menu', // 申込受付
      },
      {
        "index": Config.MENU_FLAG_98_26,
        "icon": WMSICons.MENU_ICON_ADMIN_6,
        "route": Config.PAGE_FLAG_98_26,
        "type": 'Menu', // 解约受付
      },
      {
      ...
      },
      {
        ...
        "children": [
          ...
          {
            "index": Config.MENU_FLAG_98_24,
            "icon": WMSICons.MENU_ICON_98_24,
            "route": Config.PAGE_FLAG_98_24, // ユーザーライセンス管理 ->従業員マスタ
          },
        ]
      },
      {
    ...
    return [
      ...
      },
      {
        ...
        "children": [
          ...
          {
            "index": Config.MENU_FLAG_2_16,
            "icon": WMSICons.MENU_ICON_2_16,
            "route": Config.PAGE_FLAG_2_16, // 入荷確定データ 出力
          },
        ]
      },
      {
        ...
        "children": [
          ...
          {
            "index": Config.MENU_FLAG_3_28,
            "icon": WMSICons.MENU_ICON_3_28,
            "route": Config.PAGE_FLAG_3_28, // 出荷確定データ出力
          },
        ]
      },
      {
      ...
      },
      {
        ...
        "children": [
          ...
          {
            "index": Config.MENU_FLAG_5_3,
            "icon": WMSICons.MENU_ICON_5_3,
            "route": Config.PAGE_FLAG_5_3, //棚卸データ出力
          },
        ]
      },
      {
        ...
        "children": [
          ...
          {
            "index": Config.MENU_FLAG_8_8,
            "icon": WMSICons.MENU_ICON_8_8,
            "route": 'formMaster', // 帳票マスタ
          },
        ]
      },
      {
      ...
      },
      {
        ...
        "children": [
          ...
          {
            "index": Config.MENU_FLAG_60_98_25,
            "icon": WMSICons.MENU_ICON_60_98_25,
            "route": Config.PAGE_FLAG_60_98_25, // 申込明细
          },
        ]
      },
      {
        ...
        "children": [
          ...
          {
            "index": Config.MENU_FLAG_98_22,
            "icon": WMSICons.MENU_ICON_98_22,
            "route": 'chargeManagement', // 課金法人管理
          },
          {
            "index": Config.MENU_FLAG_98_23,
            "icon": WMSICons.MENU_ICON_98_23,
            "route": Config.PAGE_FLAG_98_23, // ライセンス管理
          },
          {
            "index": Config.MENU_FLAG_98_24,
            "icon": WMSICons.MENU_ICON_98_24,
          ...
          {
            "index": Config.MENU_FLAG_98_25,
            "icon": WMSICons.MENU_ICON_98_25,
            "route": Config.PAGE_FLAG_98_25, // 申込受付
          },
          {
            "index": Config.MENU_FLAG_98_26,
            "icon": WMSICons.MENU_ICON_98_26,
            "route": Config.PAGE_FLAG_98_26, // 解约受付
          },
        ]
      },
      {
  ...
  Widget build(BuildContext context) {
    // 当controller与特定的位置关联后，你可以在任何时候滚动到那里
    Future.delayed(Duration.zero, () {
      _horizontalScrollController.animateTo(0,
    ...
    return Material(
      ...
      child: BlocProvider<HomeMenuBloc>(
        create: (context) => HomeMenuBloc(HomeMenuModel(context,
            menuInfoList:
                adminFlg ? _createAdminMenuList() : _createMenuList())),
        child: Container(
                ...
                children: [
                    ...
                    child: Container(
                      ...
                      child: Scrollbar(
                        ...
                        child: SingleChildScrollView(
                          ...
                          controller: _horizontalScrollController,
                          child: Container(
                            width: StoreProvider.of<WMSState>(context)
                                    .state
                                    .menuExpand
                  ...
                  Container(
                    width: StoreProvider.of<WMSState>(context).state.menuExpand
                        ? 328
                        : 168,
                    height: StoreProvider.of<WMSState>(context).state.menuExpand
