    ...
    return BlocBuilder<InquiryScheduleDetailsBloc, InquiryScheduleDetailsModel>(
      builder: (context, state) {
        return Column(
          children: [
            // 表单标题
            InquiryScheduleDetailsFormTitle(),
            // 表单内容
...
// 表单标题
class InquiryScheduleDetailsFormTitle extends StatefulWidget {
  const InquiryScheduleDetailsFormTitle({super.key});

  @override
  State<InquiryScheduleDetailsFormTitle> createState() =>
      _InquiryScheduleDetailsFormTitleState();
}

class _InquiryScheduleDetailsFormTitleState
    extends State<InquiryScheduleDetailsFormTitle> {
  // 当前悬停下标
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      height: 24,
                      child: Text(
                        WMSLocalizations.i18n(context)!.delivery_form_canaName,
                        textAlign: TextAlign.left,
                        style: TextStyle(
                          fontWeight: FontWeight.w400,
                          fontSize: 14,
