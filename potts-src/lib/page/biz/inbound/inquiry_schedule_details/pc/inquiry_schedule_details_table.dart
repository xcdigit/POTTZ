                  ...
                  child: Container(
                    child: Column(
                      ...
                      children: [
                        ...
                        WMSInputboxWidget(
                          text: state.receiveDetailCustomize['prodect_size']
                              .toString(),
                          readOnly: true,
                          inputBoxCallBack: (value) {
                            // 设定入荷指示明细值事件
                        ...
                        WMSInputboxWidget(
                          text:
                              state.receiveDetailCustomize['lot_no'].toString(),
                          readOnly: true,
                          inputBoxCallBack: (value) {
                            // 设定入荷指示明细值事件
                            context.read<InquiryScheduleDetailsBloc>().add(
                                SetReceiveDetailValueEvent('lot_no', value));
                          },
                        ),
                        Padding(
                          padding: EdgeInsets.only(top: 16),
                        ...
                        WMSInputboxWidget(
                          ...
                          maxLines: 5,
                          text:
                              state.receiveDetailCustomize['note1'].toString(),
                          readOnly: true,
                          inputBoxCallBack: (value) {
                            // 设定出荷指示明细值事件
                            context.read<InquiryScheduleDetailsBloc>().add(
                                SetReceiveDetailValueEvent('note1', value));
                          },
                        ),
                        Padding(
                          padding: EdgeInsets.only(top: 16),
                  ...
                  child: Container(
                    child: Column(
                      ...
                      children: [
                        ...
                        WMSInputboxWidget(
                          text: state.receiveDetailCustomize['product_code']
                              .toString(),
                          readOnly: true,
                          inputBoxCallBack: (value) {
                            // 设定入荷指示明细值事件
                        ...
                        WMSInputboxWidget(
                          text: state.receiveDetailCustomize['product_num']
                              .toString(),
                          readOnly: true,
                          inputBoxCallBack: (value) {
                            // 设定入荷指示明细值事件
                        ...
                        WMSDateWidget(
                          text: state.receiveDetailCustomize['limit_date']
                              .toString(),
                          readOnly: true,
                          dateCallBack: (value) {
                            // 设定出荷指示值事件
                        ...
                        WMSInputboxWidget(
                          text: state.receiveDetailCustomize['serial_no']
                              .toString(),
                          readOnly: true,
                          inputBoxCallBack: (value) {
                            // 设定入荷指示明细值事件
                            context.read<InquiryScheduleDetailsBloc>().add(
                                SetReceiveDetailValueEvent('serial_no', value));
                          },
                        ),
                        Padding(
                          padding: EdgeInsets.only(top: 16),
                        ...
                        WMSInputboxWidget(
                          ...
                          maxLines: 5,
                          text:
                              state.receiveDetailCustomize['note2'].toString(),
                          readOnly: true,
                          inputBoxCallBack: (value) {
                            // 设定出荷指示明细值事件
                            context.read<InquiryScheduleDetailsBloc>().add(
                                SetReceiveDetailValueEvent('note2', value));
                          },
                        ),
                        Padding(
                          padding: EdgeInsets.only(top: 16),
                        ...
                        WMSInputboxWidget(
                          height: 136,
                          maxLines: 5,
                          text: state.receiveDetailCustomize['notice_note1']
                              .toString(),
                          readOnly: true,
                          inputBoxCallBack: (value) {
                            // 设定出荷指示明细值事件
                  ...
                  child: Container(
                    child: Column(
                      ...
                      children: [
                        ...
                        Visibility(
                          visible: state.receiveDetailCustomize[
                                      'product_image1'] ==
                                  null ||
                        ...
                        WMSInputboxWidget(
                          height: 136,
                          maxLines: 5,
                          text: state.receiveDetailCustomize['notice_note2']
                              .toString(),
                          readOnly: true,
                          inputBoxCallBack: (value) {
                            // 设定出荷指示明细值事件
  ...
  Widget build(BuildContext context) {
    return FractionallySizedBox(
      ...
      child: Container(
        ...
        child: WMSTableWidget<InquiryScheduleDetailsBloc,
            InquiryScheduleDetailsModel>(
