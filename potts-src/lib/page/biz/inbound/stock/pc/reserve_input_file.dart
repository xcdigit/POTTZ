 ...
 * 时间：2023/08/18
 */
class ReserveInputFile extends StatefulWidget {
  const ReserveInputFile({super.key});

  @override
  State<ReserveInputFile> createState() => _ReserveInputFileState();
}

class _ReserveInputFileState extends State<ReserveInputFile> {
  // 当前下标
  int currentIndex = Config.NUMBER_NEGATIVE;
  // 当前悬停下标
        ...
        MouseRegion(
          ...
          child: GestureDetector(
            onTap: () {
              ...
              setState(() {
                // 当前下标
                currentIndex = fileItemList[i]['index'];
              });
              // 判断循环下标
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                color: currentIndex == fileItemList[i]['index']
  ...
  void _importFileCallBack(List<List<Map<String, dynamic>>> content) {
    // 导入CSV文件事件
    context.read<ReserveInputBloc>().add(ImportCSVFileEvent(context, content));
  }
    ...
    List _fileItemList = [
      {
        ...
        'title': WMSLocalizations.i18n(context)!.reserve_input_16,
      },
    ];
