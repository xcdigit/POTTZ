              ...
              child: Column(
                children: [
                  Container(
                    ...
                    child: RevenueAndExpenditureTableButton(),
                  ),
...
// 受払照会-表格按钮
class RevenueAndExpenditureTableButton extends StatefulWidget {
  const RevenueAndExpenditureTableButton({super.key});

  @override
  State<RevenueAndExpenditureTableButton> createState() =>
      _RevenueAndExpenditureTableButtonState();
}

class _RevenueAndExpenditureTableButtonState
    extends State<RevenueAndExpenditureTableButton> {
  // 初始化左侧按钮列表
  _initButtonLeftList(List buttonItemList, RevenueAndExpenditureModel state) {
        ...
        MouseRegion(
          ...
          child: GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color:
                    _stop[i] ? Color.fromRGBO(0, 122, 255, .6) : Colors.white,
                border: Border.all(
                  color: _stop[i]
...
class _RevenueAndExpenditureTableContentState
  ...
  @override
  Widget build(BuildContext context) {
    return WMSTableWidget<RevenueAndExpenditureBloc,
      ...
      columns: [
        ...
        },
        {
          'key': 'year_month',
          'width': 2,
          'title': WMSLocalizations.i18n(context)!.menu_content_4_10_11,
        },
        {
          'key': 'product_code',
          'width': 7,
        ...
        },
        {
          'key': 'num',
          'width': 2,
          'title': WMSLocalizations.i18n(context)!.menu_content_4_10_12,
        },
        {
          'key': 'action_name',
          'width': 3,
          'title': WMSLocalizations.i18n(context)!.menu_content_4_10_1,
        },
      ],
