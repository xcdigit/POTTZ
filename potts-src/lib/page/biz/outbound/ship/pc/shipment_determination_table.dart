...
import 'package:wms/page/biz/outbound/ship/pc/shipment_determination_detail_page.dart';
                  ...
                  child: Column(
                    children: [
                      Container(
                        ...
                        child: ShipmentDeterminationTableButton(),
                      ),
                      ShipmentDeterminationTableContent(),
                    ],
                  ),
                ),
              ),
...
// 出荷确定-表格按钮
class ShipmentDeterminationTableButton extends StatefulWidget {
  const ShipmentDeterminationTableButton({super.key});

  @override
  State<ShipmentDeterminationTableButton> createState() =>
      _ShipmentDeterminationTableButtonState();
}

class _ShipmentDeterminationTableButtonState
    extends State<ShipmentDeterminationTableButton> {
  // 初始化左侧按钮列表
...
class _ShipmentDeterminationTableContentState
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<ShipmentDeterminationBloc, ShipmentDeterminationModel>(
      builder: (context, state) {
        return WMSTableWidget<ShipmentDeterminationBloc,
            ShipmentDeterminationModel>(
