...
class _InstructionInputTableContentState
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<OutboundQueryBloc, OutboundQueryModel>(
      ...
      return WMSTableWidget<OutboundQueryBloc, OutboundQueryModel>(
        // key: _tableWidgetKey,
        columns: [
          {
            'key': 'id',
          ...
          },
          {
            ...
            'width': 3,
            'title':
                WMSLocalizations.i18n(context)!.instruction_input_form_basic_5,
          },
          {
            'key': 'customer_name',
            'width': 3,
        ...
        operatePopupOptions: [
          {
            ...
            'callback': (_, value) {
              ...
              if (value['ship_kbn'] == Config.NUMBER_TWO.toString() ||
                ...
                context.go(
                    '/' + Config.PAGE_FLAG_3_12 + '/' + value['id'].toString());
              } else {
                // 消息提示
                WMSCommonBlocUtils.tipTextToast(
                    WMSLocalizations.i18n(context)!.outbound_notes_toast_1);
              }
            },
          }
        ],
