        ...
        children: [
          ...
          FractionallySizedBox(
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  DisplayInstructionButton(bloc: context),
              ...
              child: MaterialButton(
                ...
                onPressed: () {
                  ...
                  if (tabItemList[i]['index'] == Config.NUMBER_ZERO) {
                    ...
                    setState(() {
                      context.read<DisplayInstructionBloc>().add(
                          QueryShipStateEvent(['1'], tabItemList[i]['index']));
                      // 当前内容
                      // currentContent = widget.initTableList;
                    });
                    ...
                    setState(() {
                      context.read<DisplayInstructionBloc>().add(
                          QueryShipStateEvent(['2'], tabItemList[i]['index']));
                    });
                    ...
                    setState(() {
                      context.read<DisplayInstructionBloc>().add(
                          QueryShipStateEvent(['7'], tabItemList[i]['index']));
                    });
                  }
                  // 赵士淞 - 测试修复 2023/11/17 - 终
                },
            ...
            if (currentIndex != Config.NUMBER_ONE)
              {
                ...
                'callback': (_, value) {
                  ...
                  menuBloc.read<HomeMenuBloc>().add(PageJumpEvent(
                      '/instructioninput/' + value["id"].toString()));
                },
              },
            {
              'title': WMSLocalizations.i18n(context)!
