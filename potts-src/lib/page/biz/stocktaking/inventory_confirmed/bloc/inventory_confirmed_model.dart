 ...
 * 时间：2023/10/09
 */
class InventoryConfirmedModel extends WmsTableModel {
  // 克隆
  factory InventoryConfirmedModel.clone(InventoryConfirmedModel src) {
    InventoryConfirmedModel dest =
        InventoryConfirmedModel(context: src.context);
    dest.copy(src);
    // 自定义参数 - 始
  ...
  InventoryConfirmedModel({
    ...
    this.queryConfirmFlg = const ['1', '2'],
    this.sum1 = 0,
    this.sum2 = 0,
    this.sum3 = 0,
