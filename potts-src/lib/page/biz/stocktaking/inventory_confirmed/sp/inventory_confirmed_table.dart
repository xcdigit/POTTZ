...
class _InventoryConfirmedTableContentState
  ...
  Widget build(BuildContext context) {
    return WMSTableWidget<InventoryConfirmedBloc, InventoryConfirmedModel>(
      ...
      // 赵士淞 - 始
      operatePopupHeight:
          context.read<InventoryConfirmedBloc>().state.queryConfirmFlg.length ==
                  2
              ? 134
              : 94,
      operatePopupOptions: context
                  .read<InventoryConfirmedBloc>()
                  .state
                  .queryConfirmFlg
                  .length ==
          ...
          : context.read<InventoryConfirmedBloc>().state.queryConfirmFlg[0] ==
                  '2'
              ? [
                  {
                    'title': WMSLocalizations.i18n(context)!
