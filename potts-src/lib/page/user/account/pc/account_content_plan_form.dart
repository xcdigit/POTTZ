  ...
  List<Widget> _initPlanList() {
    ...
    planList.add(
      Container(
        ...
        margin: EdgeInsets.fromLTRB(0, 34, 0, 51),
          ...
          children: [
            ...
            Text(
              WMSLocalizations.i18n(context)!.plan_content_text_2 +
                  ...
                  context.read<AccountBloc>().state.spaceMaxNumber.toString() +
            ...
            GestureDetector(
              onPanDown: (details) {
                ...
                if (context.read<AccountBloc>().state.role3UserNumber >=
                    context.read<AccountBloc>().state.planData['account_num']) {
                  // 消息提示
                  WMSCommonBlocUtils.tipTextToast(
                      WMSLocalizations.i18n(context)!.plan_content_text_25);
                  return;
