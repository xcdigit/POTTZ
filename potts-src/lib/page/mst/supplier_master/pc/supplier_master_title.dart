...
class SupplierMasterTitle extends StatefulWidget {
  // 标记
  String flag;

  SupplierMasterTitle({super.key, this.flag = ''});

  @override
  State<SupplierMasterTitle> createState() => _SupplierMasterTitleState();
}

class _SupplierMasterTitleState extends State<SupplierMasterTitle> {
  // 当前悬停下标
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: Text(
              WMSLocalizations.i18n(context)!.menu_content_8_10,
              style: TextStyle(
                height: 1.0,
                fontSize: 24,
                fontWeight: FontWeight.w500,
