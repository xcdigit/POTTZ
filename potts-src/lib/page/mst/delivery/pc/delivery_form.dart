...
// ignore: must_be_immutable
class DeliveryFormContent extends StatefulWidget {
  int flag;
  DeliveryFormContent({super.key, this.flag = 0});

  @override
  State<DeliveryFormContent> createState() => _DeliveryFormContentState();
}

class _DeliveryFormContentState extends State<DeliveryFormContent> {
  @override
  Widget build(BuildContext context) {
    //商品数据取出
                  ...
                  children: [
                    Container(
                      ...
                      child: Row(
                        children: [
                          Text(
                            WMSLocalizations.i18n(context)!.delivery_form_name,
                            style: TextStyle(
                              fontWeight: FontWeight.w400,
                              fontSize: 14,
                              color: Color.fromRGBO(6, 14, 15, 1),
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    WMSPostalcodeWidget(
                      text: state.formInfo['postal_cd'],
                      readOnly: state.stateFlg == '2',
                      country: 'JP',
                      postalCodeCallBack: (value) {
                        context.read<DeliveryBloc>().add(SetDeliveryValueEvent(
                            'postal_cd', value['postal_code'].toString()));
                        if (value['code'] == '0') {
                          //设定都道府县和市町村
                  ...
                  children: [
                    ...
                    WMSInputboxWidget(
                      ...
                      inputBoxCallBack: (value) {
                        ...
                        context
                            .read<DeliveryBloc>()
                            .add(SetDeliveryValueEvent('company_note1', value));
                      },
                    ),
                  ],
                ),
                  ...
                  children: [
                    ...
                    WMSInputboxWidget(
                      ...
                      inputBoxCallBack: (value) {
                        ...
                        context
                            .read<DeliveryBloc>()
                            .add(SetDeliveryValueEvent('company_note2', value));
                      },
                    ),
                  ],
                ),
                  ...
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        child: DeliveryFormButton(state: state),
                      ),
                    ),
                  ],
                ),
...
class DeliveryFormButton extends StatefulWidget {
  DeliveryModel state;
  DeliveryFormButton({super.key, required this.state});
  ...
  Widget build(BuildContext context) {
    ...
    List _buttonItemList = [
      ...
      },
      {
        ...
        'title': context.read<DeliveryBloc>().state.formInfo['id'] == null ||
                context.read<DeliveryBloc>().state.formInfo['id'] == '' ||
                context.read<DeliveryBloc>().state.stateFlg == '2'
