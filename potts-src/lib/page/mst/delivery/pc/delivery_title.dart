...
class DeliveryTitle extends StatefulWidget {
  // 标记
  String flag;

  DeliveryTitle({super.key, this.flag = ''});

  @override
  State<DeliveryTitle> createState() => _DeliveryTitleState();
}

class _DeliveryTitleState extends State<DeliveryTitle> {
  // 当前悬停下标
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: Text(
              WMSLocalizations.i18n(context)!.menu_content_8_23,
              style: TextStyle(
                  fontWeight: FontWeight.w500,
                  fontSize: 24,
                  height: 1.0,
