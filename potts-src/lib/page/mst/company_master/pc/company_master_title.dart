...
class CompanyMasterTitle extends StatefulWidget {
  // 标记
  String flag;

  CompanyMasterTitle({super.key, this.flag = ''});

  @override
  State<CompanyMasterTitle> createState() => _CompanyMasterTitleState();
}

class _CompanyMasterTitleState extends State<CompanyMasterTitle> {
  // 当前悬停下标
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: Text(
              WMSLocalizations.i18n(context)!.menu_content_8_1,
              style: TextStyle(
                fontWeight: FontWeight.w500,
                fontSize: 24,
                height: 1.0,
