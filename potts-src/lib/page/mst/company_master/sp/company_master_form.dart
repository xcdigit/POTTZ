...
class CompanyMasterForm extends StatefulWidget {
  ...
  @override
  State<CompanyMasterForm> createState() => _InformationSocietyFormtate();
}

class _InformationSocietyFormtate extends State<CompanyMasterForm> {
  @override
  Widget build(BuildContext context) {
    ...
    return BlocProvider<CompanyMasterBloc>(
      ...
      child: BlocBuilder<CompanyMasterBloc, CompanyMasterModel>(
...
class CompanyMasterFormButton extends StatefulWidget {
  ...
  int companyId;
  CompanyMasterFormButton(
      {super.key, required this.state, required this.companyId});
