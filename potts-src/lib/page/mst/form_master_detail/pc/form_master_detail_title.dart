 ...
 * 时间：2023/12/25
 */
class FormMasterDetailTitle extends StatefulWidget {
  const FormMasterDetailTitle({super.key});

  @override
  State<FormMasterDetailTitle> createState() => _FormMasterDetailTitleState();
}

class _FormMasterDetailTitleState extends State<FormMasterDetailTitle> {
  // 当前悬停下标
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: Text(
              WMSLocalizations.i18n(context)!.form_detail_title,
              style: TextStyle(
                fontWeight: FontWeight.w500,
                fontSize: 24,
                height: 1.0,
