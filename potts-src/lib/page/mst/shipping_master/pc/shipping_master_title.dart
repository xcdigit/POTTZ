...
class ShippingMasterTitle extends StatefulWidget {
  // 标记
  String flag;

  ShippingMasterTitle({super.key, this.flag = ''});

  @override
  State<ShippingMasterTitle> createState() => _ShippingMasterTitleState();
}

class _ShippingMasterTitleState extends State<ShippingMasterTitle> {
  // 当前悬停下标
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: Text(
              WMSLocalizations.i18n(context)!.menu_content_8_3,
              style: TextStyle(
                fontWeight: FontWeight.w500,
                fontSize: 24,
                height: 1.0,
