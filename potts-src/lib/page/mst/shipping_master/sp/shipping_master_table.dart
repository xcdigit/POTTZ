              ...
              FractionallySizedBox(
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      Container(
                        child: ShippingMasterInformationTableButton(),
                      ),
...
class ShippingMasterInformationTableButton extends StatefulWidget {
  const ShippingMasterInformationTableButton({super.key});

  @override
  State<ShippingMasterInformationTableButton> createState() =>
      _ShippingMasterInformationTableButtonState();
}

class _ShippingMasterInformationTableButtonState
    extends State<ShippingMasterInformationTableButton> {
  // 初始化左侧按钮列表
        ...
        buttonList.add(
          GestureDetector(
            onTap: () {
              ...
              GoRouter.of(context).push('/shippingMaster/form/0').then((value) {
                // 判断返回值
