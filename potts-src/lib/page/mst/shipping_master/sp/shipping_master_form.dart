        ...
        builder: (context, state) {
          ...
          List<Widget> _initFormBasic() {
            return [
                      ...
                      children: [
                        ...
                        WMSInputboxWidget(
                          ...
                          inputBoxCallBack: (value) {
                            ...
                            context
                                .read<ShippingMasterBloc>()
                                .add(SetMessageValueEvent('postal_cd', value));
                          },
                        ),
                      ],
                    ),
                      ...
                      WMSInputboxWidget(
                        ...
                        inputBoxCallBack: (value) {
                          ...
                          context.read<ShippingMasterBloc>().add(
                              SetMessageValueEvent('contact_email', value));
                        },
                      ),
                    ],
                  ),
              ...
              // 占位
              if (state.roleId != 1) FractionallySizedBox(widthFactor: 1),
              // 会社名称
              state.roleId == 1
                  ? FractionallySizedBox(
                      widthFactor: 1,
                    ...
                    children: [
                      ...
                      WMSInputboxWidget(
                        ...
                        inputBoxCallBack: (value) {
                          // 设定值
                          context.read<ShippingMasterBloc>().add(
                              SetMessageValueEvent('company_note1', value));
                        },
                      ),
                    ],
                  ),
                    ...
                    children: [
                      ...
                      WMSInputboxWidget(
                        ...
                        inputBoxCallBack: (value) {
                          // 设定值
                          context.read<ShippingMasterBloc>().add(
                              SetMessageValueEvent('company_note2', value));
                        },
                      ),
                    ],
                  ),
