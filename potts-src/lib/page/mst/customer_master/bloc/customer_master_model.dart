 ...
 * 时间：2023/10/9
 */
class CustomerMasterModel extends WmsTableModel {
  factory CustomerMasterModel.clone(CustomerMasterModel src) {
    CustomerMasterModel dest = CustomerMasterModel(
      context: src.context,
  ...
  // 会社名集合
  List<Map<String, dynamic>> salesCompanyInfoList = [];
  // 检索条件
