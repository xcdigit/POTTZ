...
class CustomerMasterTitle extends StatefulWidget {
  // 标记
  String flag;

  CustomerMasterTitle({super.key, this.flag = ''});

  @override
  State<CustomerMasterTitle> createState() => _CustomerMasterTitleState();
}

class _CustomerMasterTitleState extends State<CustomerMasterTitle> {
  // 当前悬停下标
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: Text(
              WMSLocalizations.i18n(context)!.menu_content_8_6,
              style: TextStyle(
                fontWeight: FontWeight.w500,
                fontSize: 24,
                height: 1.0,
