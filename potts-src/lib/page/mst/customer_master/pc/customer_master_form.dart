...
// ignore: must_be_immutable
class CustomerMasterFormContent extends StatefulWidget {
  int flag; //按钮跳转判断
  CustomerMasterFormContent({super.key, this.flag = 0});

  @override
  State<CustomerMasterFormContent> createState() =>
      _CustomerMasterFormContentState();
}

class _CustomerMasterFormContentState extends State<CustomerMasterFormContent> {
  @override
  Widget build(BuildContext context) {
    //商品数据取出
                    ...
                    WMSInputboxWidget(
                      ...
                      inputBoxCallBack: (value) {
                        ...
                        context.read<CustomerMasterBloc>().add(
                            SetCustomerValueEvent('corporation_number', value));
                      },
                    ),
                  ],
                ),
                  ...
                  children: [
                    ...
                    WMSInputboxWidget(
                      ...
                      inputBoxCallBack: (value) {
                        ...
                        context
                            .read<CustomerMasterBloc>()
                            .add(SetCustomerValueEvent('contact_email', value));
                      },
                    ),
                  ],
                ),
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    WMSDateWidget(
                      text: state.formInfo['application_start_date'].toString(),
                      readOnly: state.stateFlg == '2',
                      dateCallBack: (value) {
                        // 设定值
                        context.read<CustomerMasterBloc>().add(
                  ...
                  children: [
                    ...
                    WMSInputboxWidget(
                      ...
                      inputBoxCallBack: (value) {
                        ...
                        context
                            .read<CustomerMasterBloc>()
                            .add(SetCustomerValueEvent('company_note1', value));
                      },
                    ),
                  ],
                ),
                  ...
                  children: [
                    ...
                    WMSInputboxWidget(
                      ...
                      inputBoxCallBack: (value) {
                        ...
                        context
                            .read<CustomerMasterBloc>()
                            .add(SetCustomerValueEvent('company_note2', value));
                      },
                    ),
                  ],
                ),
                          ...
                          Expanded(
                            ...
                            child: WMSInputboxWidget(
                              ...
                              inputBoxCallBack: (value) {
                                // 设定值
                                context.read<CustomerMasterBloc>().add(
                                    SetCustomerValueEvent('limit_date', value));
                              },
                            ),
                          ),
                          Container(
                        ...
                        child: Column(
                          ...
                          children: <WMSLabelRadio>[
                            WMSLabelRadio(
                              label: 'OFF',
                              value: 0,
                              groupValue: state.formInfo['limit_date_flg'] ==
                                      null
                                  ? 0
                                  : int.parse(state.formInfo['limit_date_flg']),
                              onChanged: (int? value) {
                                // 设定值
                                context.read<CustomerMasterBloc>().add(
                                    SetCustomerValueEvent(
                  ...
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        child: CustomerMasterFormButton(state: state),
                      ),
                    ),
                  ],
                ),
...
class CustomerMasterFormButton extends StatefulWidget {
  ...
  CustomerMasterFormButton({super.key, required this.state});
            ...
            child: OutlinedButton(
              ...
              onPressed: () {
                ...
                if (buttonItemList[i]['index'] == Config.NUMBER_ZERO) {
                  //清除表单数据
                  context.read<CustomerMasterBloc>().add(ClearFormEvent());
  ...
  Widget build(BuildContext context) {
    ...
    List _buttonItemList = [
      ...
      },
      {
        ...
        'title': context.read<CustomerMasterBloc>().state.formInfo['id'] ==
                    null ||
                context.read<CustomerMasterBloc>().state.formInfo['id'] == '' ||
                context.read<CustomerMasterBloc>().state.stateFlg == '2'
