              ...
              FractionallySizedBox(
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      Container(
                        child: LocationMasterTableButton(),
                      ),
                      LocationMasterTableContent(
                        state: state,
                      ),
                    ],
                  ),
...
// 表格按钮
class LocationMasterTableButton extends StatefulWidget {
  const LocationMasterTableButton({super.key});

  @override
  State<LocationMasterTableButton> createState() =>
      _LocationMasterTableButtonState();
}

class _LocationMasterTableButtonState extends State<LocationMasterTableButton> {
  // 初始化左侧按钮列表
  _initButtonList(List buttonItemList, LocationMasterModel state) {
    ...
    return BlocBuilder<LocationMasterBloc, LocationMasterModel>(
      builder: (context, state) => Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Container(
            child: Row(
              children: _initButtonList(_buttonLeftItemList, state),
            ),
          ),
          Container(
          ...
          Container(
            child: Container(
              child: Row(
                children: _initButtonList(_buttonRightItemList, state),
              ),
            ),
          )
        ]),
