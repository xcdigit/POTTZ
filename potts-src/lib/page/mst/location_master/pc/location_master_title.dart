...
class LocationMasterTitle extends StatefulWidget {
  // 标记
  String flag;

  LocationMasterTitle({super.key, this.flag = ''});

  @override
  State<LocationMasterTitle> createState() => _LocationMasterTitleState();
}

class _LocationMasterTitleState extends State<LocationMasterTitle> {
  // 当前悬停下标
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: Text(
              WMSLocalizations.i18n(context)!.menu_content_8_16,
              style: TextStyle(
                fontWeight: FontWeight.w500,
                fontSize: 24,
                height: 1.0,
