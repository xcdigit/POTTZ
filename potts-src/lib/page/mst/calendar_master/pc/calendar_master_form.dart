                  ...
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        child: CalendarMasterFormButton(),
                      ),
                    ),
                  ],
                ),
...
// 営業日マスタ-表单按钮
class CalendarMasterFormButton extends StatefulWidget {
  const CalendarMasterFormButton({super.key});

  @override
  State<CalendarMasterFormButton> createState() =>
      _CalendarMasterFormButtonState();
}

class _CalendarMasterFormButtonState extends State<CalendarMasterFormButton> {
  // 初始化按钮列表
          ...
          child: OutlinedButton(
            ...
            onPressed: () {
              ...
              if (buttonItemList[i]['index'] == Config.NUMBER_ZERO) {
                // 清空营业事件
                context.read<CalendarMasterBloc>().add(ClearCalendarEvent());
  ...
  Widget build(BuildContext context) {
    ...
    List _buttonItemList = [
      ...
      },
      {
        ...
        'title': context.read<CalendarMasterBloc>().state.selectedId ==
