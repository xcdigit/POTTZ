...
class CalendarMasterTitle extends StatefulWidget {
  // 标记
  String flag;

  CalendarMasterTitle({super.key, this.flag = ''});

  @override
  State<CalendarMasterTitle> createState() => _CalendarMasterTitleState();
}

class _CalendarMasterTitleState extends State<CalendarMasterTitle> {
  // 当前悬停下标
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: Text(
              WMSLocalizations.i18n(context)!.menu_content_8_21,
              style: TextStyle(
                fontWeight: FontWeight.w500,
                fontSize: 24,
                height: 1.0,
