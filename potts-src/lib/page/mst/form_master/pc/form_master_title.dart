...
class FormMasterTitle extends StatefulWidget {
  // 标记
  String flag;

  FormMasterTitle({super.key, this.flag = ''});

  @override
  State<FormMasterTitle> createState() => _FormMasterTitleState();
}

class _FormMasterTitleState extends State<FormMasterTitle> {
  // 当前悬停下标
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: Text(
              WMSLocalizations.i18n(context)!.menu_content_8_8,
              style: TextStyle(
                fontWeight: FontWeight.w500,
                fontSize: 24,
                height: 1.0,
