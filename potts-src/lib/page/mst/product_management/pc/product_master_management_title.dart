...
class ProductMasterManagementTitle extends StatefulWidget {
  // 标记
  String flag;

  ProductMasterManagementTitle({super.key, this.flag = ''});

  @override
  State<ProductMasterManagementTitle> createState() =>
      _ProductMasterManagementTitleState();
}

class _ProductMasterManagementTitleState
    extends State<ProductMasterManagementTitle> {
  // 当前悬停下标
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: Text(
              WMSLocalizations.i18n(context)!.menu_content_8_4,
              style: TextStyle(
                fontWeight: FontWeight.w500,
                fontSize: 24,
                height: 1.0,
