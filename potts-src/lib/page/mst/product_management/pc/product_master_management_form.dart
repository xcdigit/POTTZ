        ...
        child: Container(
          ...
          child: ListView(
            children: [
              ...
              // 表单内容
              ProductMasterManagementFormContent(
                flag: widget.flag,
              ),
            ],
          ),
...
// ignore: must_be_immutable
class ProductMasterManagementFormContent extends StatefulWidget {
  int flag;
  ProductMasterManagementFormContent({super.key, this.flag = 0});

  @override
  State<ProductMasterManagementFormContent> createState() =>
      _ProductMasterManagementFormContentState();
}

class _ProductMasterManagementFormContentState
    extends State<ProductMasterManagementFormContent> {
  @override
  Widget build(BuildContext context) {
    //商品数据取出
      ...
      builder: (context, state) {
        ...
        List<Widget> _initFormBasic() {
          return [
            ...
            //商品名称
            FractionallySizedBox(
              widthFactor: state.productNameLength,
              child: Container(
                height: 72,
                margin: EdgeInsets.fromLTRB(0, 0, 0, 16),
                child: Column(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      state.productInfo['id'] != null &&
                          ...
                          ? WMSInputboxWidget(
                              text:
                                  state.productInfo['company_name'].toString(),
                              readOnly: true,
                              inputBoxCallBack: (value) {},
                            )
                          : WMSDropdownWidget(
                          ...
                          Expanded(
                            ...
                            child: WMSInputboxWidget(
                              ...
                              inputBoxCallBack: (value) {
                                ...
                                context
                                    .read<ProductMasterManagementBloc>()
                                    .add(SetProductValueEvent('jan_cd', value));
                              },
                            ),
                          ),
                          Container(
                  ...
                  children: [
                    ...
                    WMSInputboxWidget(
                      ...
                      inputBoxCallBack: (value) {
                        context
                            .read<ProductMasterManagementBloc>()
                            .add(SetProductValueEvent('company_note1', value));
                      },
                    ),
                  ],
                ),
                  ...
                  children: [
                    ...
                    WMSInputboxWidget(
                      ...
                      inputBoxCallBack: (value) {
                        context
                            .read<ProductMasterManagementBloc>()
                            .add(SetProductValueEvent('company_note2', value));
                      },
                    ),
                  ],
                ),
                  ...
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        child: ProductMasterManagementFormButton(state: state),
                      ),
                    ),
                  ],
                ),
...
class ProductMasterManagementFormButton extends StatefulWidget {
  ...
  ProductMasterManagementFormButton({super.key, required this.state});
      ...
      },
      {
        ...
        'title': context
                ...
                context
                        ...
                        .productInfo['id'] ==
                    '' ||
                context.read<ProductMasterManagementBloc>().state.stateFlg ==
                    '2'
