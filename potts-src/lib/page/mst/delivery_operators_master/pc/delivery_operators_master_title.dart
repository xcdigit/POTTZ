...
class DeliveryOperatorsMasterTitle extends StatefulWidget {
  // 标记
  String flag;

  DeliveryOperatorsMasterTitle({super.key, this.flag = ''});

  @override
  State<DeliveryOperatorsMasterTitle> createState() =>
      _DeliveryOperatorsMasterTitleState();
}

class _DeliveryOperatorsMasterTitleState
    extends State<DeliveryOperatorsMasterTitle> {
  // 当前悬停下标
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: Text(
              WMSLocalizations.i18n(context)!.menu_content_8_7,
              style: TextStyle(
                fontWeight: FontWeight.w500,
                fontSize: 24,
                height: 1.0,
