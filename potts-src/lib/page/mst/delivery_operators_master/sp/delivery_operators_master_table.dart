...
class _OperatorsMasterTableTabState extends State<OperatorsMasterTableTab> {
  ...
  List<Widget> _initTabList(
      List tabItemList, DeliveryOperatorsMasterModel state) {
    // Tab列表
    List<Widget> tabList = [];
    // 循环Tab单个列表
...
class _OperatorsMasterTableContentState
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<DeliveryOperatorsMasterBloc,
        DeliveryOperatorsMasterModel>(builder: (context, state) {
      // 右侧按钮单个列表
          ...
          WMSTableWidget<DeliveryOperatorsMasterBloc,
            ...
            columns: [
              ...
              },
              {
                ...
                'key': 'postal_cd',
                'width': 0.5,
                'title': WMSLocalizations.i18n(context)!.delivery_table_zipCode,
              },
              {
                //都道府県
                'key': 'addr_1',
              ...
              },
              {
                ...
                'key': 'addr_3',
                'width': 0.5,
                'title': WMSLocalizations.i18n(context)!.delivery_table_address,
              },
              {
                //電話番号
                'key': 'tel',
