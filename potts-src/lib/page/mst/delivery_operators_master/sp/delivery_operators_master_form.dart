                      ...
                      WMSPostalcodeWidget(
                        ...
                        postalCodeCallBack: (value) {
                          ...
                          if (value['code'] == '0') {
                            ...
                            context
                                .read<DeliveryOperatorsMasterBloc>()
                                .add(SetOperatorsValueEvent('postal_cd', ''));
                            //设定都道府县和市町村
                            context
                                .read<DeliveryOperatorsMasterBloc>()
                                .add(SetOperatorsValueEvent('addr_1', ''));
                            context
                                .read<DeliveryOperatorsMasterBloc>()
                                .add(SetOperatorsValueEvent('addr_2', ''));
                            context
                                .read<DeliveryOperatorsMasterBloc>()
                                .add(SetOperatorsValueEvent('addr_3', ''));
                            // 郵便番号入力错误
                            WMSCommonBlocUtils.errorTextToast(value['msg']);
                          }
                        },
                      ),
                    ],
                    ...
                    children: [
                      ...
                      WMSInputboxWidget(
                        ...
                        inputBoxCallBack: (value) {
                          // 设定值
                          context.read<DeliveryOperatorsMasterBloc>().add(
                              SetOperatorsValueEvent('contact_tel', value));
                        },
                      ),
                    ],
                  ),
                    ...
                    children: [
                      ...
                      WMSInputboxWidget(
                        ...
                        inputBoxCallBack: (value) {
                          // 设定值
                          context.read<DeliveryOperatorsMasterBloc>().add(
                              SetOperatorsValueEvent('contact_fax', value));
                        },
                      ),
                    ],
                  ),
                    ...
                    children: [
                      ...
                      WMSDateWidget(
                        ...
                        dateCallBack: (value) {
                          if (value != '') {
                            context.read<DeliveryOperatorsMasterBloc>().add(
                                SetOperatorsValueEvent('start_date', value));
                          } else {
                            context
                                .read<DeliveryOperatorsMasterBloc>()
              ...
              Visibility(
                ...
                child: FractionallySizedBox(
                  ...
                  child: Container(
                    ...
                    child: DeliveryOperatorsMasterFormButton(
                      state: state,
...
class DeliveryOperatorsMasterFormButton extends StatefulWidget {
  ...
  int deliveryId;
  DeliveryOperatorsMasterFormButton(
