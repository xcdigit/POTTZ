...
class _WarehouseMasterFormState extends State<WarehouseMasterForm> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider<WarehouseMasterBloc>(
      create: (context) {
        return WarehouseMasterBloc(
          WarehouseMasterModel(context: context, companyId: companyId),
        );
      },
...
// ignore: must_be_immutable
class WarehouseMasterFormContent extends StatefulWidget {
  int flag;
  WarehouseMasterFormContent({super.key, this.flag = 0});

  @override
  State<WarehouseMasterFormContent> createState() =>
      _WarehouseMasterFormContentState();
}

class _WarehouseMasterFormContentState
    extends State<WarehouseMasterFormContent> {
  @override
  Widget build(BuildContext context) {
    //仓库数据取出
            ...
            child: OutlinedButton(
              ...
              onPressed: () {
                ...
                if (buttonItemList[i]['index'] == Config.NUMBER_ZERO) {
                  //清除表单数据
                  context.read<WarehouseMasterBloc>().add(ClearFormEvent());
  ...
  Widget build(BuildContext context) {
    ...
    List _buttonItemList = [
      ...
      },
      {
        ...
        'title': widget.state.stateFlg == '2' ||
                (widget.state.stateFlg == '1' &&
                    (widget.state.formInfo['id'] == null ||
                        widget.state.formInfo['id'] == ''))
