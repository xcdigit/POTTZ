...
class WarehouseMasterTitle extends StatefulWidget {
  // 标记
  String flag;

  WarehouseMasterTitle({super.key, this.flag = ''});

  @override
  State<WarehouseMasterTitle> createState() => _WarehouseMasterTitleState();
}

class _WarehouseMasterTitleState extends State<WarehouseMasterTitle> {
  // 当前悬停下标
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: Text(
              WMSLocalizations.i18n(context)!.menu_content_8_19,
              style: TextStyle(
                fontWeight: FontWeight.w500,
                fontSize: 24,
                height: 1.0,
