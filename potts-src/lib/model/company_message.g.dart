...
part of 'company_message.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

CompanyMessage _$CompanyMessageFromJson(Map<String, dynamic> json) =>
    CompanyMessage(
      (json['id'] as num?)?.toInt(),
      json['title'] as String?,
      json['message'] as String?,
      (json['push_kbn'] as num?)?.toInt(),
...
Map<String, dynamic> _$CompanyMessageToJson(CompanyMessage instance) {
  ...
  val['push_kbn'] = instance.push_kbn;
